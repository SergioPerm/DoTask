...
class OnBoardingSpeechView: UIView {

    weak var viewModel: OnBoardingSpeechViewModelType? {
        didSet {
            bindViewModel()
        }
    }
...
private extension OnBoardingSpeechView {
    func setup() {
        ...
        allowNotificationsBtn.localizableString = LocalizableStringResource(stringResource: R.string.localizable.onboarding_ALLOW_SPEECH)
