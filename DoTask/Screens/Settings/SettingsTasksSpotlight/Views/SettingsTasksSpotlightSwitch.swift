//
//  SettingsTasksSpotlightToggle.swift
//  DoTask
//
...
class SettingsTasksSpotlightSwitch: UIView {

    var changeSettingHandler: (() -> Void)?
    var spotlight: Bool {
        didSet {
            switchControl.isOn = spotlight
        }
    }
    ...
    let title: LocalizableLabel = {
        ...
        label.localizableString = LocalizableStringResource(stringResource: R.string.localizable.settings_SPOTLIGHT_VALUE)
...
extension SettingsTasksSpotlightSwitch {
    private func setup() {
        addSubview(title)
