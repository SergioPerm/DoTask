//
//  SettingsTasksSpotlightViewController.swift
//  DoTask
//
...
class SettingsTasksSpotlightViewController: UIViewController, SettingsTasksSpotlightViewType {

    private let viewModel: SettingsTasksSpotlightViewModelType

    var presentableControllerViewType: PresentableControllerViewType
    var router: RouterType?
    var persistentType: PersistentViewControllerType?
    
    private let switchView: SettingsTasksSpotlightSwitch = {
        let view = SettingsTasksSpotlightSwitch()
        view.translatesAutoresizingMaskIntoConstraints = false
        
        return view
    }()
    
    private let infoView: SettingsTasksSpotlightInfo = {
        let view = SettingsTasksSpotlightInfo()
        view.translatesAutoresizingMaskIntoConstraints = false
        
        return view
    }()
    
    init(viewModel: SettingsTasksSpotlightViewModelType, router: RouterType?, presentableControllerViewType: PresentableControllerViewType) {
...
extension SettingsTasksSpotlightViewController {
    private func bindViewModel() {
        switchView.spotlight = viewModel.outputs.spotlight
        switchView.changeSettingHandler = { [weak self] in
            self?.viewModel.inputs.changeSpotlightSetting()
        }
    }
    ...
    private func setupNavbar() {
        ...
        settingsNavBarTitleView.setTitle(localizeString: LocalizableStringResource(stringResource: R.string.localizable.settings_SPOTLIGHT_TITLE))
